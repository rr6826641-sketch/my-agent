...
MODEL_CATALOG = [
    ...
    {"id": "nousresearch/hermes-4-405b",
     "label": "Hermes 4 405B (Flagship)", "tag": "reasoning",
     "uncensored": True,
     "desc": "Flagship uncensored — exploit chain / cyber / reasoning"},
    {"id": "nousresearch/hermes-4-70b",
     "label": "Hermes 4 70B", "tag": "reasoning", "uncensored": True,
     "desc": "Uncensored neutral-alignment reasoning model"},
    ...
    {"id": "gryphe/mythomax-l2-13b",
     "label": "MythoMax L2 13B (Mythos-line)", "tag": "uncensored", "uncensored": True,
     "desc": "Mythos-lineage de-aligned uncensored — heavy creative/offensive depth"},
    {"id": "nousresearch/hermes-3-llama-3.1-405b",
     "label": "Hermes 3 405B", "tag": "reasoning", "uncensored": True,
     "desc": "Hermes-3 405B uncensored flagship — deep reasoning & exploit chains"},
    {"id": "thinkingmachines/inkling-small:free",
     "label": "Inkling Small (Free)", "tag": "free", "uncensored": True,
     "desc": "Free uncensored lightweight — fast everyday ops"},
